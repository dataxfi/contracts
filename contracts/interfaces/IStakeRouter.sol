 ...
 */
function setParamUint(bytes32 key, uint256 value, string paramName )  external;
...
function StakeERC20toDT(address dtpoolAddress,uint amountIn, uint256[] calldata tokenAmountsOut,address[] calldata path,address datatoken,  uint256 deadline, address refStakingAddress, uint256 refStakingFees ) payable external ;
...
@param refStakingFees is the fees being extracted by the specific entity for the staking operation.
 */
...
@param refStakingAddress is the address of the third party that will be paying the fees
@param refStakingFees is the fees being extracted from the specific entity for the staking operation.
*/
...
@param refUnstakingFees is the fees being extracted from the specific entity for the Unstaking operation.
@param deadline is the timestemp before which the txn with amountOutMin should be transactioned.

 */

function UnstakeDTtoERC20(address dtpoolAddress, uint256 poolAmountIn, uint256 amountOutMin ,address[] calldata  path ,address to, address refUnstakingAddress , uint256 refUnstakingFees ) payable  external;
...
*/
function UnstakeDTtoETH(address dtpoolAddress, uint256 poolAmountIn, uint256 amountOutMin , address[] calldata  path , address refUnstakingAddress , uint256 refUnstakingFees ) payable  external;
